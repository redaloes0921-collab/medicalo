...
- **핵심 프로그램**: 모공(피지형·흉터형·탄력저하형), 흉터, 색소(기미·주근깨·잡티·오타), CRO 볼륨

### 콘텐츠 우선순위 (2026-07-26 확정)

| 순위 | 주제 | 비중 가이드 |
|------|------|------------|
| **메인** | 모공 (피지형/흉터형/탄력저하형), 흉터 (여드름 흉터, 흉터 재생) | 주간 소재의 60~70% |
| **서브** | 색소 질환 — 기미 중심 (주근깨/잡티/오타 보조) | 주간 소재의 30~40% |

일일 기획 시 메인 주제를 우선 배정하고, 색소는 시즌 이슈(자외선 등)가 있을 때 가중.
